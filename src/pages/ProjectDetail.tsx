          ...
          >
            ...
            <div className="w-full h-56 sm:h-72 md:h-80 rounded-2xl bg-gradient-to-br from-primary/10 via-surface-lighter to-accent/5 flex items-center justify-center mb-10 gradient-border">
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-3 rounded-2xl bg-primary/10 flex items-center justify-center">
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-primary-light">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              ...
              {project.challenges && project.challenges.length > 0 && (
                <div className="glass rounded-2xl p-6">
                  <h2 className="text-lg font-semibold text-text mb-4 flex items-center gap-2">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-primary-light">
